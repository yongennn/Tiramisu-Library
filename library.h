...
void Reserve_Book(); void LibraryService(); void ServiceDetails(const char *serviceName);void management();
...
void showmembership(int memberID); void payfine(int memberID);void digital_resource(int memberID);
